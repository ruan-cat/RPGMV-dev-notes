...
![image-20221129155137613](https://gh-img-store.ruan-cat.com/img/image-20221129155137613.png)

- 完全不能识别的情况

![image-20221129155202158](https://gh-img-store.ruan-cat.com/img/image-20221129155202158.png)
...
![2023-02-19-13-07-10](https://gh-img-store.ruan-cat.com/img/2023-02-19-13-07-10.png)

该项目的间距等格式化相关的信息都不太合适，想要快速格式化，这里是推荐在项目根目录内新建`.editorconfig`文件，并且去配置`indent_style = tab`。

- 右键新建文件
  > ![2023-02-19-13-19-35](https://gh-img-store.ruan-cat.com/img/2023-02-19-13-19-35.png)
- 修改`indent_style`配置
  > ![2023-02-19-13-20-13](https://gh-img-store.ruan-cat.com/img/2023-02-19-13-20-13.png)

最后在`prettier`等格式化插件的配置下，就可以格式化本文件了，如下图所示：

![2023-02-19-13-21-51](https://gh-img-store.ruan-cat.com/img/2023-02-19-13-21-51.png)
...
![2023-02-20-11-31-06](https://gh-img-store.ruan-cat.com/img/2023-02-20-11-31-06.png)

## picgo

![2023-02-19-14-28-13](https://gh-img-store.ruan-cat.com/img/2023-02-19-14-28-13.png)
