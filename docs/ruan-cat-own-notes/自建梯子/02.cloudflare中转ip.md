...
![image-20230421095128326](D:\common-software\typora-img-temp-store\image-20230421095128326.png)

#### 会话设置填写账号和密码

![image-20230421095320381](D:\common-software\typora-img-temp-store\image-20230421095320381.png)

#### 会话增加来自 v2rayN 提供的代理

新建代理

![image-20230421095730173](D:\common-software\typora-img-temp-store\image-20230421095730173.png)

- 类型 socks5
- 主机 本地 localhost 127.0.0.1
- 监听端口号 10808

![image-20230421095837988](D:\common-software\typora-img-temp-store\image-20230421095837988.png)
...
![image-20230421100132469](D:\common-software\typora-img-temp-store\image-20230421100132469.png)

#### Xshell 7 链接成功

使用命令 `lsmod | grep bbr` 检查曾经安装过 BBR 加速，以便检查服务器是否可用。

![image-20230421095018527](D:\common-software\typora-img-temp-store\image-20230421095018527.png)
...
![image-20230421100420684](D:\common-software\typora-img-temp-store\image-20230421100420684.png)
...
![image-20230421101120544](D:\common-software\typora-img-temp-store\image-20230421101120544.png)

输入正确域名，这里我输入`new-york-node.ruan-cat.com`

![image-20230421104125166](D:\common-software\typora-img-temp-store\image-20230421104125166.png)

![image-20230421104210701](D:\common-software\typora-img-temp-store\image-20230421104210701.png)

- 然后输入 v2ray status 查看一下运行状态

![image-20230421104312156](D:\common-software\typora-img-temp-store\image-20230421104312156.png)

- 输入命令：v2ray url，即可生成 vmess url 链接，粘贴到客户端 V2RayN 即可上网

```
vmess:
```
...
![image-20230421105036592](D:\common-software\typora-img-temp-store\image-20230421105036592.png)

- 始终使用 HTTPS

![image-20230421105255528](D:\common-software\typora-img-temp-store\image-20230421105255528.png)
...
![image-20230421110143760](D:\common-software\typora-img-temp-store\image-20230421110143760.png)

已开启。

![image-20230421110324068](D:\common-software\typora-img-temp-store\image-20230421110324068.png)

### 客户端 V2Ray 配置信息

参考资料：https://github.com/233boy/v2ray/wiki/V2RayN使用教程

导入后的 vmess 服务器

![image-20230421110935102](D:\common-software\typora-img-temp-store\image-20230421110935102.png)

链接自建的节点。这里根据韦景堂的注意事项选择`自动配置系统代理`，路由`绕过大陆`。

![image-20230421111220150](D:\common-software\typora-img-temp-store\image-20230421111220150.png)
